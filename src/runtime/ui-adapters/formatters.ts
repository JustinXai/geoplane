...
const LOCAL_TEST_DISPLAY_NAMES: Readonly<Record<string, string>> = Object.freeze({
  "Sample Local Platform (Pilot Fixture)": "本地验收平台（测试数据）",
  "Sample Local Agency (Pilot Fixture)": "本地验收代理商（测试数据）",
  "Sample Local Client (Pilot Fixture)": "本地验收客户（测试数据）",
  "Sample Local Closed Pilot Project": "本地验收项目（测试数据）",
  "Sample Platform Operator (Pilot Fixture)": "本地验收平台（测试数据）",
  "Sample Content Agency (Pilot Fixture)": "本地验收代理商（测试数据）",
  "Sample Manufacturing Enterprise (Pilot Fixture)": "本地验收制造企业（测试数据）",
  "Sample Secondary Enterprise (Pilot Fixture)": "本地验收企业二（测试数据）",
  "Sample Client (Pilot Fixture)": "本地验收客户（测试数据）",
  "Sample Project (Pilot Fixture)": "本地验收项目（测试数据）",
});
...
export function safeBusinessDisplayName(value: string, kind: "组织" | "项目" | "内容" = "组织"): string {
  ...
  if (/\b(?:sample|fixture|mock|demo)\b|pilot\s+fixture/i.test(value)) return `本地测试${kind}（测试数据）`;
  return value;
}
