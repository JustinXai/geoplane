/**
 * GET /api/projects/[projectId]/review-queue — opportunity summaries awaiting a
 * client review decision: opportunities that passed validation (VALIDATED) but
 * have no HumanReviewDecision yet, returned as OpportunityViewV1[]. Unauthenticated
 * -> 401; cross-tenant -> 403; unknown project -> 404. Checkpoint GEO_READ_API_V1
 * (Agent E4).
 */
...
export async function GET(
  ...
  return toHttpResponse(apiOk(toReviewQueueViews(opportunities, validations, reviews)));
}
